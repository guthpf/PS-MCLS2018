...
int main() {
	...
	Method<n> * f[] = {
		new Hybrid<n,m>(&problem, "IP-SGD Hybrid (ζ_{k}~.9)", 1., 0., H, forget_const<9, 10>),
		new Hybrid<n,m>(&problem, "IP-SGD Hybrid (ζ_{k}~.5)", 1., 0., H, forget_const<5, 10>),
		new Hybrid<n,m>(&problem, "IP-SGD Hybrid (ζ_{k}~.2)", 1., 0., H, forget_const<2, 10>),
		new Hybrid<n,m>(&problem, "IP-SGD Hybrid (ζ_{k}~.1)", 1., 0., H, forget_const<1, 10>),
		new Hybrid<n,m>(&problem, "IP-SGD Hybrid (ζ_{k}~.01)", 1., 0., H, forget_const<1, 100>),
	};
